<tr>
    <td class="border-b border-beig p-4 pl-8 text-lila-fosc"> {{$prestamo->user_id}}</td>
    <td class="border-b border-beig p-4 pl-8 text-lila-fosc"> {{$prestamo->book_id}}</td>
    <td class="border-b border-beig p-4 pl-8 text-lila-fosc"> {{$prestamo->fecha_prestamo}}</td>
    <td class="border-b border-beig p-4 pl-8 text-lila-fosc">{{$prestamo->fecha_devolucion}}</td>
